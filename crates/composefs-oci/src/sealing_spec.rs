...
//! ## Future Directions
//!
//! Separate design work is underway on incremental pulls (fetching only missing content objects) and a canonical tar format to support pushing after such a pull; that work is not yet ready to reference here.
//!
//! ## References
//!
